...
# Parameters for movie recommendation system
...
#Presenting the movie similarities
...
# Most viewed movies presentation of data
library(ggplot2)
...
table_views[1:6,]
# Bar plot of total number of views
...
# Setting the data science recommendation system model
